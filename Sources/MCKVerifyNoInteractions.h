...
// Mocking Syntax
#define mck_verifyNoMoreInteractionsOn(mock) mck_verify(mck_checkNoInteractions(mock))
#define mck_verifyNoInteractionsOn(mock)     mck_verify(mck_checkNoInteractions(mock))
