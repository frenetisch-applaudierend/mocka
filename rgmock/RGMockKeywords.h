...
// Safe syntax
#define mock_verify if ([mock_updatedContext() updateContextMode:RGMockContextModeVerifying])
...
// Safe syntax
#define mock_stub if ([mock_updatedContext() updateContextMode:RGMockContextModeStubbing])
